programa
{
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		notas_100 = valor_saque / 100 // siga esta ideia para programar as duas linhas abaixo
	...
	{
		se (notas_100 + notas_50 + notas_20 + notas_10 > 0) {
			Graficos.definir_cor(Graficos.criar_cor(180, 180, 180))
			Graficos.desenhar_retangulo(5, 430, 574, 245, verdadeiro, verdadeiro)
		}
		se (notas_100 > 0) {
			para (inteiro n = 0; n < notas_100; n++) {
				Graficos.desenhar_imagem(n * 10 + 15, 440 + n * 10, cem_reais)
			}
		}
		
		se (notas_50 > 0) {
			para (inteiro n = 0; n < notas_50; n++) {
				Graficos.desenhar_imagem(n * 10 + 195, 440 + n * 10, cinquenta_reais)
			}
		}
	...
	funcao inicializa()
	{
		...
		cem_reais = Graficos.carregar_imagem ("100_reais.png")
